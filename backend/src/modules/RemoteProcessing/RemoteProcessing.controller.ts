...
import RemoteTransactionsController from "../RemoteTransaction/RemoteTransaction.controller";
import { TransactionStatus } from "../RemoteTransaction/RemoteTransaction.model";
import { processingNamespace } from "../../server";
import RemoteInitiatorController from "../RemoteInitiator/RemoteInitiator.controller";
import WindowsAppInstanceController from "../WindowsAppInstance/WindowsAppInstance.controller";
...
class RemoteProcessingController {
    static async receiveAndForwardProcessingCommand(req: Request, res: Response) {
        ...
        // DYNAMIC IMPORT: Use dynamic import to avoid issues with node-fetch in ESM mode
