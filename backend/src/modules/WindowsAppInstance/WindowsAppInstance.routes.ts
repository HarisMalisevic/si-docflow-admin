...
router.post("/report-devices/:instance_id/", WindowsAppInstanceController.reportAvailableDevices); // used by the Windows app, thus no AuthMiddleware authorization
