...
import { initUniversalDeviceInterfaceLog } from './UniversalDeviceInterfaceLog';
import { initHeadlessDevice } from './HeadlessDevice';
...
db.headless_devices = initHeadlessDevice(sequelize_obj);
