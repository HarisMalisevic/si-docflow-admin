...
API_ROUTER.get("/api/message", AuthMiddleware.isLoggedIn, AuthMiddleware.isSuperAdmin, (req, res) => {
...
API_ROUTER.get("/api/auth/status/super", AuthMiddleware.isLoggedIn, AuthMiddleware.isSuperAdmin, (req, res) => {
